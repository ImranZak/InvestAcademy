        ...
        <Card sx={{ maxWidth: 800, margin: '20px auto', padding: '20px', boxShadow: 3 }}>
            <CardContent>
                ...
                <Dialog open={dialogOpen} onClose={handleDialogClose}>
                    ...
                    <DialogActions>
                        <Button onClick={handleDialogClose} variant="contained" color="primary" component={Link} to="/dashboard">Main Menu</Button>
                        <Button onClick={handleRetake} variant="contained" color="primary">Retake Test</Button>
                    </DialogActions>
                </Dialog>
            </CardContent>
        </Card>
